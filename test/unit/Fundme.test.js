...
//  NOTE with this ternary operator, unit test only gonna run on development chains and skip the testnet
!developmentChains.includes(network.name)
  ...
  : describe("Fundme", () => {
      ...
      beforeEach(async function () {
        ...
        // Here fixture will deploy all the deploy scripts which have "all" tag
      ...
      describe("fund", () => {
        ...
        it("Fails if don't send enough ETH", async () => {
          ...
          ); //NOTE revertedWith message should be same as your FundeMe.sol file's fund() revert message
      ...
      describe("withdraw", () => {
        ...
        it("can withdraw ETH from a single funder", async () => {
          ...
          const endingDelpoyerBalance = await fundMe.provider.getBalance(
            deployers
          );
